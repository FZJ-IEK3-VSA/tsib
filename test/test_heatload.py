...
def test_heatload():
    ...
    bdgcfg = cfg.BuildingConfiguration({'ID':ID, 'weatherData': try_data, 'weatherID': 'TRY_4',
    ...
    if abs(q_sim - q_iwu) > 30:
        raise ValueError('The difference between simulation and the values listed by the IWU is too high.')
